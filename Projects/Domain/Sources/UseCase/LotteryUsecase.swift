...
public protocol LotteryUsecaseProtocol {
...
public final class LotteryUsecase: LotteryUsecaseProtocol {

    private let repository: LotteryRepository
    
    public init(repository: LotteryRepository) {
    ...
    public func getMoreLotteryList(
        turn: Int,
        completion: @escaping(Result<[Lottery], Error>) -> Void
    ) {
        var lotteryList: [Lottery] = []
